...
function PostPage({ posts, replies, addReply, comments = {}, addComment }) {
  ...
  // Use addComment for comment input
  ...
  // Get comments for this postId (if comments is an object keyed by postId)
  ...
  return (
    <div className="feed">
      ...
      {postComments && postComments.length > 0 && (
        <div className="post__comments" style={{ margin: "16px 0" }}>
          <h3 style={{ fontSize: "16px", margin: "8px 0" }}>Comments</h3>
